...
const JoystickComponents = (props: GalaadJoystickProps) => {
    ...
    const joystickDiv: HTMLDivElement = document.querySelector("#galaad-joystick") as HTMLDivElement
...
const ButtonComponents = ({ buttonNumber = 1, ...props }: GalaadJoystickProps) => {
    /**
...
export const GalaadJoystick = forwardRef<HTMLDivElement, GalaadJoystickProps>((props, ref) => {
    ...
    return (
        <div ref={ref}>
            <div id="galaad-joystick" style={joystickWrapperStyle} onContextMenu={(e) => e.preventDefault()}>
                <Canvas
                    shadows
                    orthographic
                    camera={{
            ...
            </div>
            {
                ...
                <div id="galaad-button" style={buttonWrapperStyle} onContextMenu={(e) => e.preventDefault()}>
                    <Canvas
                        shadows
                        orthographic
                        camera={{
